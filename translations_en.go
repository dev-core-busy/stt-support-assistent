...
var enOverrides = map[string]string{
	...
	"Hinweis: Die Jarvis- und die Kundenverwaltungs-API müssen noch angepasst werden, damit mit diesen Schlagworten passende Tickets gesucht und angezeigt werden können.": "Note: The Jarvis and customer management APIs still need to be adapted so that matching tickets can be searched and displayed using these keywords.",
